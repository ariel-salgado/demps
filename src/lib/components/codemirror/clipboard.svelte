...
<button
	class="rounded-md bg-primary-50 p-1 outline outline-1 outline-slate-300 transition-colors duration-300 focus-within:bg-primary-100 hover:bg-primary-100"
